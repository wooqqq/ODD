package odd.manager.common.evaluation.controller;

import odd.manager.common.evaluation.dto.response.*;
import odd.manager.common.evaluation.service.EvaluationService;
...
public class EvaluationController {
    ...
    public ResponseEntity<?> getFavoriteCategoryItems(@PathVariable String userId, @PathVariable String platform) {
    ...
    public ResponseEntity<?> getPurchaseItems(@PathVariable String userId, @PathVariable String platform) {
